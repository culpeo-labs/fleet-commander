...
pub enum AppEvent {
    ...
    McpSendToWorkspace {
        ...
        target_id: AgentId,
        message: String,
        /// Correlation id (Feature 2d) so the two agents can thread a
        /// request/reply exchange. Generated by the tool when the sender
        /// starts a new thread; echoed back by the recipient when replying.
        thread: String,
    },
